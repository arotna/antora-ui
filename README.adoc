...
:hide-uri-scheme:
// Project URLs:
:url-project: https://github.com/arotna/antora-ui
...
This project is based on the default Antora UI, with the following changes:

* no 'edit this page'
* supports tabs as per https://gitlab.com/antora/antora-asciidoctor-extensions/-/tree/master/tabs-block
* supports inclusion of logo.png
